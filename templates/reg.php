<?php 
if($_POST){
	if($M->register($_POST['name'],md5($_POST['pass']))){
...
<div class="am-g">
  <div class="col-lg-6 col-md-8 col-sm-centered">
    <form action="" method="post" class="am-form">
      ...
      <input type="text" name="name" id="reg_name" value="">
      <br>
      <label for="password">密码:</label>
      <input type="password" name="pass" id="reg_password" value="">
      <br>
      <div class="am-cf">
        <input type="submit" name="" value="注 册" class="am-btn am-btn-primary am-btn-sm am-fl">
		<a href="index.php?action=login" class="am-btn am-btn-default am-btn-sm am-fr" role="button">有了帐号? </a>
      </div>
    </form>
    <hr>
